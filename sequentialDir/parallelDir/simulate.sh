...
time ./parallelExample.sh $N $MODIFIEDBEAMLINE $CORR1 $CORR2 $VERTICLE
...
time ./runParallelPseudoinverse.sh $BPM1 $DESIGNBEAMLINE $MODIFIEDBEAMLINE $VERTICLE
...
time ./runParallelCompareM.sh $BPM1 $DESIGNBEAMLINE $MODIFIEDBEAMLINE
